...
ALTER SEQUENCE public.usr_id_seq OWNED BY public.person.id;
...
ALTER TABLE ONLY public.person ALTER COLUMN id SET DEFAULT nextval('public.usr_id_seq'::regclass);
...
59	0	0	0	0	0	2000	0	0	0	0	2024-05-13
\.
...
1	admin	$2a$10$Q84eB0c.TlK2fujJeLj82u.ohjhod5KhBqDoCY5n4.xLBds36Mgpm	ROLE_ADMIN
102	user	$2a$10$uvqU7r4SUMKfWHqr9BuQH.T1HaUPHoJe72oz6aAT.33L4o0AFUlAa	ROLE_USER
\.
...
147	340	0	0	2024-03-18
148	0	0	500	2024-02-12
151	222222	0	0	2024-03-24
152	555555	0	0	2024-03-22
154	0	1234567	0	2024-03-17
155	0	0	4532244	2024-03-24
160	24544	0	0	2024-03-26
161	400	500	300	2024-03-31
162	1000	0	0	2024-04-05
171	1000	0	0	2024-04-06
172	123	123	123	2024-04-28
175	55555	555555	55555	2024-05-05
177	300	100	250	2024-05-11
178	600	0	100	2024-05-12
180	300	0	100	2024-05-11
181	0	250	0	2024-05-12
\.
...
SELECT pg_catalog.setval('public.business_expenses_id_seq', 59, true);
...
SELECT pg_catalog.setval('public.income_shop_id_seq', 83, true);
...
SELECT pg_catalog.setval('public.person_seq', 551, true);
...
SELECT pg_catalog.setval('public.personal_expenses_id_seq', 181, true);
...
--
-- Name: usr_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.usr_seq', 1, true);
...
ALTER TABLE public.income_shop
...
--
-- Name: person usr_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
